...
public:
    ...
    static std::string task4(const std::string&);
    static std::vector<bool> task5(const std::string&, const std::vector<bool>&);
    ...
    static std::vector<bool> task10(const std::string&);
    static std::vector<bool> task11(const std::string&);
